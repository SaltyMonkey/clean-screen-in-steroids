const data = {
	...
	10155130: {
		"layer": 680,
		"chain": "PostProcess_01.PPC.S1_GlaiverAwaken00_PPC"
	},
	10152340 : {
		"layer": 680,
	...
	602101: {
		"layer": 680,
		"chain": "PostProcess_01.PPC.S1_ArcherAwaken00_PPC"
	},
	602221: {
		"layer": 680,
		"chain": "PostProcess_01.PPC.S1_ArcherAwaken00_PPC"
...
function CleanSteroids(mod) {
	...
	mod.hook("S_ABNORMALITY_BEGIN", 4, { "order": -999999999, "filter": { "fake": null } }, (event) => {
